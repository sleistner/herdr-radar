...
// after the bar (palette.band, lib/state.js bandValue). `contains`, since a
// first-row stripe has spaces in front of the bar. Longest mark first, since
// the first matching rule wins and a longer mark contains every shorter one.
